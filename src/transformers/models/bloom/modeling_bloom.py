...
class BloomModel(BloomPreTrainedModel):
    ...
    def build_alibi_tensor(self, attention_mask: torch.Tensor, num_heads: int) -> torch.Tensor:
        return build_alibi_tensor(attention_mask, num_heads)
    ...
    def forward(
        ...
        **deprecated_arguments,
        ...
        alibi = self.build_alibi_tensor(attention_mask, self.num_heads)
